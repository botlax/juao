...
/* C:\xampp\htdocs\justusandotto/themes/juao/partials/site/header.htm */
class __TwigTemplate_225cb37ffecdfe854e12da1850b65e2e954bc064d96db2e8ec885bdbb1656ff7 extends Twig_Template
{
    private $source;
...
\t\t\t</header>";
    ...
    {
        return "C:\\xampp\\htdocs\\justusandotto/themes/juao/partials/site/header.htm";
    }
...
\t\t<!-- Header -->
\t\t\t<header id=\"header\">
\t\t\t\t<a href=\"{{url('/')}}\" class=\"logo\" style=\"background-image:url('{{ logo | media }}');\">Just Us &apm; Otto</a>
\t\t\t\t<nav id=\"social-nav\">
\t\t\t\t\t<ul>
...
\t\t\t\t\t<span></span>
\t\t\t\t</a>
\t\t\t</header>", "C:\\xampp\\htdocs\\justusandotto/themes/juao/partials/site/header.htm", "");
    }
}
